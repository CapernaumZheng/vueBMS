...
window.BMAP_AUTHENTIC_KEY = ""; (function() {
  ...
  x.lang.Ca.prototype.addEventListener = function(a, b, c) {
    if (x.lang.nt(b)) { ! b.dl && (b.dl = {}); ! this.Gi && (this.Gi = {});
      var d = this.Gi,
        e;
      if (typeof c == "string" && c) { / [ ^ \w\ - ] / .test(c) && ba("nonstandard key:" + c);
        e = b.Dx = c
      }
  ...
  x.lang.Ca.prototype.removeEventListener = function(a, b) {
    ...
    if (x.lang.nt(b)) {
      ...
      b = b.dl[a].Dx
    } else if (!x.lang.sg(b)) return; ! this.Gi && (this.Gi = {});
    var c = this.Gi;
    c[a] && c[a][b] && delete c[a][b]
  };
  x.lang.Ca.prototype.dispatchEvent = function(a, b) {
    x.lang.sg(a) && (a = new x.lang.$y(a)); ! this.Gi && (this.Gi = {});
    var b = b || {},
      c;
    for (c in b) a[c] = b[c];
    var d = this.Gi,
  ...
  z.XU = z.apiLoad ||
    function() {
      z.version && z.version >= 1.5 && oa(z.wc + "?qt=verify&ak=" + pa,
        function(a) {
          if (a && a.error !== 0) {
  ...
  x.extend(Ka.prototype, {
    ...
    zg: function(a) {
      if (this.Jb !== a) {
        ...
        b.Oa = c;
        b.Jb = a;
        this.dispatchEvent(b); (a === Ya || a === Sa) && Qa(wa)
      }
    },
    Vf: function(a) {
      var b = this;
    ...
    bt: function(a, b) {
      ...
      for (var b = b || {},
             e = [], f = 0, g = d.length; f < g; f++) e.push(this.ie.Ck(d[f], this.Xb));
      d = new db;
    ...
    function(a, b, c) {
          ...
          if (!B || !B.Jo) {
            var A = b.all && a.attachEvent,
              ...
              P = function(a) {
                ...
                } else "function" == typeof a ? a(P) : ("" + a).replace(/^(?:([\w$_]+)\.)?(\w+)$/,
                  function(a, c, d) {
                    b[0] = d;
                    t.apply(P.OF(c), b)
                  })
            ...
            a.onerror = function(a, b, d, e) {
              var g = o; ! b && /^script error/i.test(a) && (Ra ? g = q: Ra = o);
      ...
      void
        function(a, b, c) {
          ...
          n && (n.xh && k() < n.xh) && (c.alog("cus.on", "time",
            function(a) {
              var b = {},
                d = q,
                e;
          ...
          if (t && t.xh && k() < t.xh) {
            var A = ["Moz", "O", "ms", "Webkit"],
              ...
              te = function() {
                return "Promise" in a && "cast" in a.lq && "resolve" in a.lq && "reject" in a.lq && "all" in a.lq && "race" in a.lq &&
                  function() {
                    var b;
                    new a.lq(function(a) {
                      b = a
  ...
  x.object.extend(I, {
      ...
      if (d.Bd == this.Fj.cq) c && b();
        ...
        if (d.Bd == this.Fj.pG) {
          ...
          e.DC == q && (e.DC = o, setTimeout(function() {
              ...
              0 == a.length ? e.XK() : oa("static/offLineBmap/getmodules.js");
              console.log(a)
            },
            1));
          d.Bd = this.Fj.JP
    ...
    lK: function(a) {
      if (a && this.rL()[a]) for (var a = this.rL()[a], b = 0; b < a.length; b++) this.lK(a[b]),
      this.Pd.ul[a[b]] || this.zN(a[b])
    },
    zN: function(a) {
    ...
    ib: function(a) {
      this.Pd.ul[a] || (this.Pd.ul[a] = {},
        this.Pd.ul[a].Bd = this.Fj.pG, this.Pd.ul[a].Ru = []);
      return this.Pd.ul[a]
    },
    remove: function(a) {
      delete this.ib(a)
    ...
    vV: function(a, b) {
      for (var c = this.Pd.Tv,
             d = o,
             e = 0,
             f = c.length; e < f; e++)"" == c[e].KE && (c[e].TM == a ? c[e].KE = b: d = q);
      d && this.XK()
    },
    XK: function() {
      for (var a = this.Pd.Tv,
             b = 0,
             c = a.length; b < c; b++) this.AZ(a[b].TM, a[b].KE);
      this.Pd.Tv.length = 0
    }
  });
  function R(a, b) {
  ...
  function gb(a, b) {
    a && (this.Mb = a, this.ba = "spot" + gb.ba++, b = b || {},
      this.Sg = b.text || "", this.zv = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5], this.uJ = b.userData || p, this.Qh = b.minZoom || p, this.Ef = b.maxZoom || p)
  }
  gb.ba = 0;
  ...
  x.extend(Sb.prototype, {
    ...
    Ge: function(a) { ! this.B && (this.initialize && Xa(this.initialize)) && (this.B = this.initialize(a));
      this.k = this.k || {
        yg: q
      };
      this.yB();
    ...
    rw: function(a) {
      if (a && Wa(a.id) && !isNaN(a.id)) {
        var b = {
          ...
          c;
        for (c in a) b[c] = a[c];
        if (a = this.sm(a.id)) for (var d in b) a[d] = b[d];
        else this.dc.push(b)
      }
    },
    sm: function(a) {
  ...
  x.object.extend(cc.prototype, {
    ...
    dF: function(a) {
      if (this.Ee[a]) {
        for (var b = 0,
               c = this.ya.length; b < c; b++) this.ya[b] && ("divider" == this.ya[b].Nb && this.ya[b].Nj == a) && (this.ya.splice(b, 1), c--),
    ...
    a.addEventListener("removeoverlay",
      function(a) {
        ...
        if (a instanceof eb) delete b.wa[a.ba];
                    ...
                    e = b.De.length; d < e; d++) if (b.De[d] === a) {
          b.De.splice(d, 1);
          break
        }
      });
  ...
  function rc(a, b, c, d) {
    a && (this.Ev = {},
      this.cL = d ? !!d: q, this.Uc = [], this.z_ = a instanceof qc ? a: p, this.HI = b === j ? o: !!(b.indexOf("%") + 1), this.Zj = isNaN(parseFloat(b)) ? 1 : this.HI ? parseFloat(b) / 100 : parseFloat(b), this.II = !!(c.indexOf("%") + 1), this.repeat = c != j ? this.II ? parseFloat(c) / 100 : parseFloat(c) : 0)
  };
  function sc(a, b) {
    x.lang.Ca.call(this);
    this.content = a;
  ...
  x.extend(sc.prototype, {
    ...
    VN: function(a) { ! a && 0 != a || (isNaN(a) || 0 > a) || (0 != a && (220 > a && (a = 220), 730 < a && (a = 730)), this.z.maxWidth = a)
    },
    Cc: function(a) {
      this.z.title = a
    },
  ...
  function yc(a, b) {
    var c = this;
    xc() && (a === j && ba(Error("\u6ca1\u6709\u4f20\u5165points\u6570\u636e")), "[object Array]" !== Object.prototype.toString.call(a) && ba(Error("points\u6570\u636e\u4e0d\u662f\u6570\u7ec4")), b = b || {},
      eb.apply(c, arguments), c.ea = {
      ia: a
    },
      c.z = {
        shape: b.shape || vc,
      ...
      this.iB = [], this.oe = [], I.load("pointcollection",
      function() {
        for (var a = 0,
               b; b = c.iB[a]; a++) c[b.method].apply(c, b.arguments);
  ...
  x.extend(Fc.prototype, {
    ...
    Cm: function(a, b, c) {
      ...
      for (d = this.Qc.length; l < d; l++) A = this.Qc[l][0],
        ...
        m = this.Sm[y],
        n = p,
        m ? (n = m.style, n.left = t + "px", n.top = v + "px", m.$e || this.nn.push([A, i, m])) : (0 < this.Ne.length ? (m = this.Ne.shift(), m.getContext("2d").clearRect( - c / 2, -c / 2, w, w), n = m.style) : (m = document.createElement("canvas"), n = m.style, n.position = "absolute", n.width = e + c + "px", n.height = e + c + "px", this.Px() && (n.WebkitTransform = "scale(1.001)"), m.setAttribute("width", w), m.setAttribute("height", w), a.appendChild(m)), m.id = y, n.left = t + "px", n.top = v + "px", -1 < y.indexOf("bg") && (t = "#F3F1EC", this.map.D.Bo && (t = this.map.D.Bo), n.background = t ? t: ""), this.nn.push([A, i, m])),
        m.style.visibility = "";
      l = 0;
    ...
    o_: function(a, b, c, d) {
      ...
      k && k.Ib ? (ub(k.Ib, b), d && (d = new R(a[0], a[1]), f = this.map.D.xe ? this.map.D.xe.style: "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Ic(k, d)), k.loaded ? this.xf() : Jc(k,
        function() {
          e.xf()
        })) : (k = this.dj[g]) && k.Ib ? (c.Rb.insertBefore(k.Ib, c.Rb.lastChild), this.ug[g] = k, ub(k.Ib, b), d && (d = new R(a[0], a[1]), f = this.map.D.xe ? this.map.D.xe.style: "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Ic(k, d)), k.loaded ? this.xf() : Jc(k,
        function() {
          e.xf()
        })) : (k = i * Math.pow(2, f.vm() - a[2]), new H(a[0] * k, a[1] * k), d = new R(a[0], a[1]), f = this.map.D.xe ? this.map.D.xe.style: "normal", d = c.getTilesUrl(d, a[2], f), k = new Kc(this, d, b, a, c), Jc(k,
        function() {
          e.xf()
        }), k.ao(), this.ug[g] = k)
    },
    ...
    oI: function(a) {
      ...
      for (var g = 0; g < c; g++) {
        ...
        if (!i.bI && !(i.qp && !this.map.Wb() || i.mM && this.map.Wb())) {
          ...
          for (A in B) {
            var E = B[A],
              C = E.info; (C[2] != f || C[2] == f && (n > C[0] || v <= C[0] || l > C[1] || e <= C[1])) && this.Hx(E)
          }
          ...
          w = [];
          for (d.MB = []; n < v; n++) for (y = l; y < e; y++) w.push([n, y]),
            d.MB.push({
              x: n,
              y: y
            });
    ...
    Tt: function(a) {
      var b = this.map.oa();
      if (!this.map.Wb() && (a ? this.map.D.w_ = a: a = this.map.D.w_, a)) for (var c = p,
                                                                                  c = "2" == z.Qy ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.Mm[d]; d++) if (e.j_ == o) {
        b.k.$b = 18;
  ...
  function Geolocation(a) {
    ...
    I.load("othersearch",
      function() {
        for (var a = 0,
               d; d = b.oe[a]; a++) b[d.method].apply(b, d.arguments)
      })
  }
  ...
  x.extend(bc.prototype, {
    ca: function() {
      ...
      b.addEventListener("iid_changed",
        function() {
          c.Pg(bc.cl + "qt=idata&iid=" + b.sA + "&fn=",
            function(b) {
  ...
  x.extend(ae, {
    ...
    yL: function(a, b, c, d, e) {
      ...
      return (ae.Hu + "?qt=pr3d&fovy=75&quality=80&panoid={panoId}&heading={panoHeading}&pitch={panoPitch}&width={width}&height={height}").replace(/\{(.*?)\}/g,
        function(a, b) {
          return f[b]
        })
    }
  ...
  function Me(a, b) {
    ...
    c.refresh();
    c.ca(De, window);
    c.ca(Ee); ! Ae && "none" != c.options.WO && (c.ca("DOMMouseScroll"), c.ca("mousewheel"));
  ...
  Me.prototype = {
    ...
    FQ: function(a) {
      if (a.BR === o) return this.OB = a.target,
        this.fx = Date.now(),
        o;
      if (this.OB && this.fx) {
        if (600 < Date.now() - this.fx) return this.fx = this.OB = p,
          o
      } else {
      ...
      if ("select" != b && "input" != b && "textarea" != b) return a.stopImmediatePropagation ? a.stopImmediatePropagation() : a.mZ = o,
        a.stopPropagation(),
        a.preventDefault(),
        this.fx = this.OB = p,
        q
    ...
    Rv: function(a) {
      var b = Ae ? a.touches[0] : a,
        ...
        d;
      if (this.enabled) {
        this.options.bN && this.options.bN.call(this, a); (this.options.Ai || this.options.zoom) && this.qJ(0);
        ...
        if (this.options.Yx && (this.options.Vk ? (c = getComputedStyle(this.Pb, p)[le].replace(/[^0-9\-.,]/g, "").split(","), d = +(c[12] || c[4]), c = +(c[13] || c[5])) : (d = +getComputedStyle(this.Pb, p).left.replace(/[^0-9-]/g, ""), c = +getComputedStyle(this.Pb, p).top.replace(/[^0-9-]/g, "")), d != this.x || c != this.y)) this.options.Ai ? this.Yd(Ie) : Ke(this.WB),
          this.Aj = [],
          this.Br(d, c),
    ...
    dT: function(a) {
      ...
      if (this.options.zoom && Ae && 1 < a.touches.length) e = ce.abs(a.touches[0].pageX - a.touches[1].pageX),
        ...
        this.J_ = ce.sqrt(e * e + f * f),
        this.Yk = o,
        b = 1 / this.K_ * this.J_ * this.scale,
        b < this.options.Xk ? b = 0.5 * this.options.Xk * Math.pow(2, b / this.options.Xk) : b > this.options.aq && (b = 2 * this.options.aq * Math.pow(0.5, this.options.aq / b)),
        this.up = b / this.scale,
        e = this.gy - this.gy * this.up + this.x,
        f = this.hy - this.hy * this.up + this.y,
    ...
    cv: function(a) {
      if (! (Ae && 0 !== a.touches.length)) {
        ...
        if (b.Yk) d = b.scale * b.up,
          d = Math.max(b.options.Xk, d),
          d = Math.min(b.options.aq, d),
          b.up = d / b.scale,
          b.scale = d,
          b.x = b.gy - b.gy * b.up + b.x,
          b.y = b.hy - b.hy * b.up + b.y,
          b.Pb.style[oe] = "200ms",
        ...
        b.options.zp && b.options.zp.call(b, a);
          ...
          if (b.oh) {
            ...
            if (Ae) if (b.GK && b.options.zoom) clearTimeout(b.GK),
              b.GK = p,
            b.options.Ap && b.options.Ap.call(b, a),
              b.zoom(b.rh, b.th, 1 == b.scale ? b.options.nW: 1),
            b.options.zp && setTimeout(function() {
    ...
    jo: function(a) {
      ...
      if (b == this.x && c == this.y) {
        if (this.oh && (this.oh = q, this.options.ey && this.options.ey.call(this)), this.mi && this.options.Gx && ("webkit" == ee && (this.PL.style[we] = "300ms"), this.PL.style.opacity = "0"), this.Bi && this.options.Gx)"webkit" == ee && (this.OO.style[we] = "300ms"),
          this.OO.style.opacity = "0"
    ...
    HU: function(a) {
      ...
      if ("zoom" == b.options.WO) {
        if (d = b.scale * Math.pow(2, 1 / 3 * (d ? d / Math.abs(d) : 0)), d < b.options.Xk && (d = b.options.Xk), d > b.options.aq && (d = b.options.aq), d != b.scale) ! b.Sy && b.options.Ap && b.options.Ap.call(b, a),
          b.Sy++,
          b.zoom(a.pageX, a.pageY, d, 400),
          setTimeout(function() {
              b.Sy--; ! b.Sy && b.options.zp && b.options.zp.call(b, a)
            },
            400)
      } else c = b.x + c,
        d = b.y + d,
    ...
    ca: function(a, b, c) { (b || this.Pb).addEventListener(a, this, !!c)
    },
    Yd: function(a, b, c) { (b || this.Pb).removeEventListener(a, this, !!c)
    },
    EC: ga(2),
    refresh: function() {
      var a, b, c, d = 0;
    ...
    scrollTo: function(a, b, c, d) {
      ...
      a = 0;
      for (b = e.length; a < b; a++) e[a].oZ && (e[a].x = this.x - e[a].x, e[a].y = this.y - e[a].y),
        this.Aj.push({
          x: e[a].x,
          y: e[a].y,
          time: e[a].time || 0
  ...
  x.extend(Ne.prototype, {
    ...
    qy: function(a, b) {
      if (b || !this.$j[this.Xc] || !(this.$j[this.Xc].panoId == a && 3 !== this.$j[this.Xc].recoType)) {
        var c = this,
          d = this.EH(a); ! b && -1 !== d && this.$j[d] && 3 !== this.$j[d].recoType ? this.Op(d) : this.AX(function(a) {
          for (var b = {},
                 d, i, k = q,
    ...
    bQ: function() {
      ...
      x.M(this.fk, "click",
        function(b) {
          if ((b = (b.srcElement || b.target).getAttribute("data-index")) && b != a.Xc) a.Op(b),
            a.P.rc(a.$j[b].panoId)
        });
