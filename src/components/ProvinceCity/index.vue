<template>
  <div class="province-city">
    <el-form-item class="page-form-item common-form-item-68" label="所属省：" prop="status" style="width: calc(50% - 20px)">
    ...
    <el-form-item class="page-form-item common-form-item-40" label="市：" prop="status" style="width: calc(50% - 20px);margin-right: 0px">
